...
exports.register = async (req, res) => {
  ...
  res.status(StatusCodes.CREATED).json({user: { name: user.name, email: user.email, role: user.role, address: user.address,userId:user._id }, token })
};
...
exports.login = async (req, res) => {
  ...
  res.status(StatusCodes.OK).json({ user: { name: user.name, email: user.email, role: user.role, address: user.address, userId: user._id }, token })
}
